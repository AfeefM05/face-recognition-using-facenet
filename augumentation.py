...
class LoadFaces:
    ...
    def __init__(self, directory):
        ...
        self.seq = iaa.Sequential([
            ...
            iaa.Sometimes(0.5, iaa.GaussianBlur(sigma=(0, 1.5))),  # Slight Gaussian blur
            iaa.LinearContrast((0.75, 1.5)),  # Contrast adjustment
            iaa.Multiply((0.8, 1.2), per_channel=0.2),  # Color multiplication
            iaa.AdditiveGaussianNoise(scale=(0, 0.02 * 255)),  # Add slight noise
            iaa.MultiplyBrightness((0.8, 1.2)),  # Slight exposure adjustment
            iaa.Affine(
